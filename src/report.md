...
* ![network_address](screenshots/1.1 Адрес сети.png)
* _**Рисунок 1.1 - Вывод адреса сети для 192.167.38.54/13**_

* ![prefix_binary_mask](screenshots/1.2 Перевод в префиксную и двоичную запись 255.255.255.0.png)
* _**Рисунок 1.2 Перевод соответственно в префиксную и двоичную запись маски 255.255.255.0**_

* ![ordinary_binary_mask](screenshots/1.3 Перевод в обычную и двоичную 15.png)
...
* ![ordinary_prefix_mask](screenshots/1.4 Перевод в обычный вид из ранее заданного префикса.png)
* _**Рисунок 1.4 - Перевод в обычную запись из ранее определенного префикса маски 11111111.11111111.11111111.11110000**_

* ![minmax_host_prefix8](screenshots/1.5 Минмакс хосты для маски префикса 8.png)
...
* ![minmax_host_binary](screenshots/1.6 Минмакс хосты для двоичной маски.png)
* _**Рисунок 1.6 - Минимальный и максимальный хосты для 12.167.38.4 с маской 11111111.11111111.00000000.00000000**_

* ![minmax_host_ordinary](screenshots/1.7 Минмакс хосты для обычной маски.png)
* _**Рисунок 1.7 - Минимальный и максимальный хосты для 12.167.38.4 с маской 255.255.254.0**_

* ![minmax_host_prefix4](screenshots/1.8 Минмакс хосты для префикса 4.png)
...
* ![localhost](screenshots/1.9 Возможные адреса для доступа к localhost.png)
...
* ![public_private_addresses](screenshots/1.10 Адреса для публичного или частного использования.png)
...
* ![gateways](screenshots/1.11 Определение возможных шлюзов.png)
...
* ![interfaces_vm1](screenshots/2.1 Сетевые интерфейсы ВМ1.png)
...
* ![interfaces_vm2](screenshots/2.2 Сетевые интерфейсы ВМ2.png)
...
* ![netplan_file_vm1](screenshots/2.3 Содержимое конф файла для ВМ1.png)
* _**Рисунок 2.3 - Содержимое файла на ВМ capricel-1**_

* ![netplan_file_vm2](screenshots/2.4 Содержимое конф файла для ВМ2.png)
...
* ![netplan_apply_vm1](screenshots/2.5 netplan apply для ВМ1.png)
* _**Рисунок 2.5 - Применение команды _netplan apply_ для ВМ capricel-1**_

* ![netplan_apply_vm2](screenshots/2.6 netplan apply для ВМ2.png)
...
* ![route_add_vm1](screenshots/2.7 Добавление маршрута ВМ1.png)
* _**Рисунок 2.7 - Добавление статического маршрута для ВМ capricel-1**_

* ![route_add_vm2](screenshots/2.8 Добавление маршрута ВМ2.png)
* _**Рисунок 2.8 - Добавление статического маршрута для ВМ capricel-2**_

* ![route_ping_vm1](screenshots/2.9 Маршруты и пинг от ВМ1.png)
* _**Рисунок 2.9 - Маршруты ВМ capricel-1 и пинг до ВМ capricel-2**_

* ![route_ping_vm2](screenshots/2.10 Маршруты и пинг от ВМ2.png)
...
* ![config_save_vm1](screenshots/2.11 Конфиг для ВМ1.png)
* _**Рисунок 2.11 - Измененный файл для ВМ capricel-1**_

* ![config_save_vm2](screenshots/2.12 Конфиг для ВМ2.png)
* _**Рисунок 2.12 - Измененный файл для ВМ capricel-2**_

* ![route_save_vm1](screenshots/2.13 netplan apply и маршруты для ВМ1.png)
* _**Рисунок 2.13 - Применение изменений и маршруты для ВМ capricel-1**_

* ![route_save_vm2](screenshots/2.14 netplan apply и маршруты для ВМ2.png)
* _**Рисунок 2.14 - Применение изменений и маршруты для ВМ capricel-2**_

* ![ping_save_vm1](screenshots/2.15 Пинг ВМ1.png)
* _**Рисунок 2.15 - Пинг ВМ capricel-1 до ВМ capricel-2**_

* ![ping_save_vm2](screenshots/2.16 Пинг ВМ2.png)
...
* ![server_vm1](screenshots/3.1 Скорость соединения через сервер.png)
* _**Рисунок 3.1 - Скорость соединения между ВМ на сервере**_

* ![client_vm2](screenshots/3.2 Скорость соединения через клиент.png)
* _**Рисунок 3.2 - Скорость соединения между ВМ на клиенте**_

## Part 4. Сетевой экран
### 4.1. Утилита iptables
* ![firewall_script_vm1](screenshots/4.3 Скрипт файервола для ВМ1.png)
* _**Рисунок 4.1 - Скрипт /etc/firewall.sh на ВМ capricel-1**_

* ![firewall_script_vm2](screenshots/4.4 Скрипт файервола для ВМ2.png)
...
* ![start_script_vm1](screenshots/4.1 Запуск скрипта на ВМ1.png)
* _**Рисунок 4.3 - Запуск /etc/firewall.sh на ВМ capricel-1 и пинг к capricel-2**_

* ![start_script_vm2](screenshots/4.2 Запуск скрипта на ВМ2.png)
...
### 4.2. Утилита nmap
* ![nmap_vm2](screenshots/4.5 nmap.png)
...
* ![netplan_r1](screenshots/5.1 netplan-файл для r1.png)
* _**Рисунок 5.1 - Файл etc/netplan/00-installer-config.yaml для r1**_

* ![netplan_r2](screenshots/5.2 netplan-файл для r2.png)
* _**Рисунок 5.2 - Файл etc/netplan/00-installer-config.yaml для r2**_

* ![netplan_ws11](screenshots/5.3 netplan-файл для ws11.png)
* _**Рисунок 5.3 - Файл etc/netplan/00-installer-config.yaml для ws11**_

* ![netplan_ws22](screenshots/5.4 netplan-файл для ws22.png)
* _**Рисунок 5.4 - Файл etc/netplan/00-installer-config.yaml для ws22**_

* ![netplan_ws21](screenshots/5.5 netplan-файл для ws21.png)
...
* ![addresses_r1](screenshots/5.6 Адреса и пинг r1.png)
* _**Рисунок 5.6 - Адреса r1 и пинг до ws11**_

* ![addresses_r2](screenshots/5.7 Адреса r2.png)
* _**Рисунок 5.7 - Адреса r2**_

* ![addresses_ws11](screenshots/5.8 Адреса ws11.png)
* _**Рисунок 5.8 - Адреса ws11**_

* ![addresses_ws22](screenshots/5.9 Адреса и пинг ws22.png)
* _**Рисунок 5.9 - Адреса ws22 и пинг до ws21**_

* ![addresses_ws21](screenshots/5.10 Адреса ws21.png)
...
* ![redirect_before_restart_r1](screenshots/5.11 переадресация не рабочая после перезагрузки.png)
* _**Рисунок 5.11 - Включение переадресации пакетов до перезагрузки системы для r1**_

* ![redirect_before_restart_r2](screenshots/5.12 переадресация не рабочая после перезагрузки r2.png)
* _**Рисунок 5.12 - Включение переадресации пакетов до перезагрузки системы для r2**_

* ![permanent_redirect_r1](screenshots/5.13 постоянная переадресация для r1.png)
* _**Рисунок 5.13 - Включение постоянной переадресации пакетов для r1 через файл _/etc/sysctl.conf_**_

* ![permanent_redirect_r2](screenshots/5.14 постоянная переадресация для r2.png)
* _**Рисунок 5.14 - Включение постоянной переадресации пакетов для r2 через файл _/etc/sysctl.conf_**_

### 5.3. Установка маршрута по умолчанию
* ![default_route_ws11](screenshots/5.15 Файл netplan и default маршрут для ws11.png)
* _**Рисунок 5.15 - Измененный файл netplan и установка default маршрута для ws11**_

* ![default_route_ws22](screenshots/5.16 Файл netplan и default маршрут для ws22.png)
* _**Рисунок 5.16 - Измененный файл netplan и установка default маршрута для ws22**_

* ![default_route_ws21](screenshots/5.17 Файл netplan и default маршрут для ws21.png)
...
* ![ping_ws11_to_r2](screenshots/5.20 пинг от ws11 до r2.png)
* _**Рисунок 5.18 - Проверка пинг от ws11 до r2 командой _sudo tcpdump -tn -i eth0_**_

### 5.4. Добавление статических маршрутов
* ![add_static_route_r1](screenshots/5.21 Файл netplan и добавление статического маршрута r1.png)
* _**Рисунок 5.19 - Измененный файл netplan и добавление статического маршрута в таблицу маршрутизации для r1**_

* ![add_static_route_r2](screenshots/5.22 Файл netplan и добавление статического маршрута r2.png)
...
* ![chosen_routes_ws11](screenshots/5.23 Выбранные маршруты с ws11.png)
...
* ![dump_r1](screenshots/5.24 Команда дампа на r1.png)
* _**Рисунок 5.22 - Вывод команды _sudo tcpdump -tnv -i eth0_ на r1**_

* ![traceroute_ws11_to_ws21](screenshots/5.25 Команда traceroute от ws11 до ws21.png)
...
* ![dump_nonexist_r1](screenshots/5.26 Дамп на r1.png)
* _**Рисунок 5.24 - Вывод команды _sudo tcpdump -n -i eth0 icmp_ на r1**_

* ![ping_nonexist_ws11](screenshots/5.27 Пинг ws11 на несуществующий адрес в сети.png)
* _**Рисунок 5.25 - Пинг с ws11 на несуществующий адрес**_

## Part 6. Динамическая настройка IP с помощью DHCP
* ![dhcp_conf_r2](screenshots/6.1 dhcpd.conf для r2.png)
* _**Рисунок 6.1 - Содержимое файла _/etc/dhcp/dhcpd.conf_ для r2**_

* ![resolv_conf_r2](screenshots/6.2 resolv.conf для r2.png)
...
* ![restart_r2](screenshots/6.0 перезапуск для r2.png)
* _**Рисунок 6.3 - Перезапуск службы isc-dhcp-server на r2**_

* ![dhcp_address_ws21](screenshots/6.3 Добавление динамического адреса на ws21.png)
* _**Рисунок 6.4 - Динамически полученный адрес для ws21, отображенный через команду _ip a_**_

* ![dhcp_address_ws21](screenshots/6.4 Пинг ws22 от ws21.png)
* _**Рисунок 6.5 - Успешный пинг от ws21 до ws22**_

* ![mac_address_ws11](screenshots/6.5 Новый мак адрес для ws11.png)
* _**Рисунок 6.6 - Указание MAC-адреса для ws11 через изменение файла _/etc/netplan/00-installer-config.yaml_**_

* ![dhcp_conf_r1](screenshots/6.6 Файл dhcpd для настройки r1.png)
* _**Рисунок 6.7 - Содержимое файла _/etc/dhcp/dhcpd.conf_ для r1**_

* ![resolv_conf_r1](screenshots/6.7 Файл resolv для r1.png)
* _**Рисунок 6.8 - Содержимое файла _/etc/resolv.conf_ для r1**_

* ![restart_r1](screenshots/6.8 перезапуск для r1.png)
* _**Рисунок 6.9 - Перезапуск службы isc-dhcp-server на r1**_

* ![address_hardware_ws11](screenshots/6.9 Добавление динамического адреса на ws11.png)
* _**Рисунок 6.10 - Добавление динамического адреса с жесткой привязкой к MAC-адресу на ws11**_

* ![ping_ws11_to_ws22](screenshots/6.10 Пинг от ws11 до ws22.png)
* _**Рисунок 6.11 - Успешный пинг от ws11 до ws22**_

* ![before_refresh_ws21](screenshots/6.11 ws21 до обновления адреса.png)
* _**Рисунок 6.12 - ws21 до обновления адреса через dhcp**_

* ![after_refresh_ws21](screenshots/6.12 ws21 после обновления адреса.png)
...
## Part 7. NAT
* ![apache_conf_ws22_r1](screenshots/7.1 Измененный файл на r1 и ws22.png)
* _**Рисунок 7.1 - Измененный файл _/etc/apache2/ports_ на r1 и ws22**_

* ![apache_start_ws22](screenshots/7.2 Запуск апача на ws22.png)
* _**Рисунок 7.2 - Запуск веб-сервера Apache на ws22**_

* ![apache_start_r1](screenshots/7.3 Запуск апача на r1.png)
* _**Рисунок 7.3 - Запуск веб-сервера Apache на r1**_

* ![firewall_conf_r2](screenshots/7.4 Добавление строк в файервол r2.png)
...
* ![ping_refuse_ws22_to_r1](screenshots/7.5 Неудачный пинг ws22 до r1.png)
* _**Рисунок 7.5 - Неудачный пинг с ws22 на r1**_

* ![firewall_conf_r2_icmp](screenshots/7.6 Добавление правила про icmp в файервол r2.png)
* _**Рисунок 7.6 - Изменение файервола на r2 с добавлением правила про icmp**_

* ![ping_success_ws22_to_r1](screenshots/7.7 Успешный пинг ws22 до r1.png)
* _**Рисунок 7.7 - Успешный пинг с ws22 на r1**_

* ![firewall_conf_r2_SNAT_DNAT](screenshots/7.8 Добавление правил SNAT DNAT в файервол на r2.png)
...
* ![check_snat_ws22_to_r1](screenshots/7.9 Успешное подключение к серверу Apache с ws22 на r1  SNAT.png)
* _**Рисунок 7.9 - Успешное подключение с ws22 к веб-серверу Apahe на r1 с помощью команды _telnet 10.100.0.11 80_**_

* ![check_dnat_r1_to_ws22](screenshots/7.10 Успешное подключение к серверу Apache с r1 на ws22 DNAT.png)
...
* ![listen_localhost_ws22](screenshots/8.1 Установка на ws22 локального веб-сервера через изменение ports conf.png)
...
* ![restart_localhost_apache_ws22](screenshots/8.2 Запуск веб-сервера на локальном хосте ws22 после изменения файла.png)
...
* ![local_redirect_ws21_to_ws22](screenshots/8.3 Локальная переадресация с ws21 на веб-сервер ws22.png)
...
* ![remote_redirect_ws11_to_ws22](screenshots/8.4 Удаленная переадресация с ws11 на веб-сервер ws22.png)
...
* ![telnet_check_ws21](screenshots/8.5 Успешное telnet подключение от ws21.png)
...
* ![telnet_check_ws11](screenshots/8.6 Успешное telnet подключение от ws11 до ws22 через ws11.png)
